...
## Time Invested: (11/7/2018 7pm - 11/8/2018 2:15am)
    ...
    My Best Results camme from the Quadratic Fitted Linear Regression:
...
## Next Potential Steps:
    1. After discussing this with Richard, I will be testing SVM on the dataset today
...
## Time Invested: (11/8/2018 1:20pm - 2:02pm, 9pm - 11:52pm )
    ...
    --UPDATE @ 11:18pm--
        By using PCA and reducing the dimensions of the second dataframe made of value that
        had the best correlation with the target, I was able to fix the problem with the training set
        having a better score than the test set
    ...
    --UPDATE @ 11:48pm--
        I was able to get the Linear Model and Quadratic Models
        to reduce their RMSE measure with the train set error being slightly worse
        than the test set RMSE measure.
        NOTE: This does not apply to the Cubic Model for some reason
# Short Comings:
    Because I got back to working on this after my adjunct and sending a good portion of my day 
    looking for Higher Order Neural Network Results and in the  worse case an alternative project 
    that will fit within the time constraint, I was unable to add the remaining features that I 
    discussed with my Professor
    - The Regularization Terms
    - The SVM, due to fixing the training vs test error problem
    - Potential using dimensionally reduction or apply math functions on certain features
